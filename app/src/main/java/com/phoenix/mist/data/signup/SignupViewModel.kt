...
import com.phoenix.mist.data.RegistrationUIState
...
class SignupViewModel : ViewModel() {
    ...
    private fun validateDataWithRules() {
        ...
        val phoneResult = Validator.validatePhone(
            phone_no = registrationUIState.value.phone_no
        )
        ...
        allValidationsPassed.value = fNameResult.status && lNameResult.status &&
                emailResult.status && phoneResult.status && passwordResult.status && privacyPolicyResult.status
